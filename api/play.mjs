...
function buildSystemPrompt({ phase, scene, revealed, turns, availableScenes, availableClues }) {
  const lines = [
    ...
    "10. HINTS: The 'hints' array must contain 3 short, imperative action phrases that suggest a *next step* to advance the plot, such as moving to a new location or starting a new line of inquiry  (e.g., 'Ask about the will,' or 'Go to the drawing room').",
